...
SerialPortOld::SerialPortOld(const char *portName)
{
...
int SerialPortOld::readSerialPort(const char *buffer, unsigned int buf_size)
{
    DWORD bytesRead{};
...
bool SerialPortOld::writeSerialPort(const char *buffer, unsigned int buf_size)
{
    DWORD bytesSend;
...
bool SerialPortOld::isConnected()
{
...
void SerialPortOld::closeSerial()
{
    CloseHandle(this->handler);
}

Data SerialPortOld::recieveData() {
    Data data;
...
Data SerialPortOld::sendData(const char *data) {
    Data dataStruct;
...
Data SerialPortOld::waitForMoves() {
    while (true) {
...
std::vector<char> SerialPortOld::getMoves() {
...
void SerialPortOld::sendMoves(std::vector<char> moves) {
