//
// This code is stolen directly from github on 07/06/24
// https://github.com/dmicha16/simple_serial_port.git
...
#ifndef RUBIKSSOLVER_SIMPLESERIAL_HPP
#define RUBIKSSOLVER_SIMPLESERIAL_HPP
...
public:
    ...
    void SendMoves(std::vector<Move> &moves);
};


#endif //RUBIKSSOLVER_SIMPLESERIAL_HPP
